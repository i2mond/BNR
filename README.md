...
Please follow the training and inference pipelines of TransCAM[1](https://github.com/liruiwen/TransCAM).

Specifically, replace the following files:

train_TransCAM.py → train_bnr.py
